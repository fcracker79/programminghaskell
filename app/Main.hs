...
import qualified BookOfMonads.Chapter1 as BoM1
import Data.Char
main :: IO ()
main = do print $ mySum [1,2,3, 4]
          print $ myProd [1, 2, 3, 4]
          print $ myLength [11,22,33,44,55,66]
          print $ myAll (5 <) [6,7,8,9]
          print $ myAll (5 <) [6,7,8,2]
          print $ myTakeWhile (5 <) [6,7,8,9, 1, 7, 9]
          print $ myDropWhile (5 <) [6,7,8,9, 1, 7, 9]
          print $ myMap (+ 1) [1,2,3]
